    ...
    const content = [
        {
            ...
            description: "The foundation for open and honest data. Tellor securely puts real world data on-chain. We aim to build a system where data reporters can push information anywhere."
        },
        {
            title: "Decentralized structure",
            description: "No admin key and run by the community. Tellor uses a smart contract, nicknamed Parachute, to hold the keys to Tellor’s governance. "
        },
        {
            title: "Future vision",
            description: "We envision a world where every person is the owner of their own data and identity. A world where institutions can no longer censor users or sell their personal information."
        },
    ];
