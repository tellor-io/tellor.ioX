...
const PastVoteItems = () => {
  //Redux State
  const voteEventsFromRedux = useSelector(
    (state) => state.graphEvents.votesData
  );
  //   console.log(voteEventsFromRedux);
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (t, r) => (
        <div className="desc-container">
          <div className="desc-link-container">
            {r.accountID && (
              <Link
                to={{ pathname: `/account/address/${r.accountID}` }}
      ...
      filters: [
        {
          text: "0x44pl...8879 submitted 9999.9 for BTC/USD",
          value: "0x44pl...8879 submitted 9999.9 for BTC/USD",
        },
        {
          text: "0xFfL2...2231 submitted 77.9 for BNB/US",
          value: "0xFfL2...2231 submitted 77.9 for BNB/US",
        },
    ...
    },
    {
      ...
      render: (t, r) => (
        <div className="status-container">
          <img
            src={r.status == "accepted" ? Check : Rejected}
            className={r.status == "accepted" ? "" : "rejected-icon"}
          />
